...
//    final static String ERROR_ALREADY_EXIST="That username is already taken.";
    ...
    String expectedErrors = ERROR_USERNAME + SEMICOLON + ERROR_PASSWORD + SEMICOLON + ERROR_EMAIL;
