...
public class RegistrationTest extends BaseTest {
    ...
    @Parameters({
            ...
            TestData.VALID_LOGIN+COMMA  + "qqq"+COMMA           + "123"+COMMA   + ERROR_EXIST_USERNAME+SEMICOLON+ERROR_EMAIL+SEMICOLON+ERROR_PASSWORD,
            SHORT_USER_NAME+COMMA       + "test@tex.com"+COMMA  + "567"+COMMA   + ERROR_USERNAME+SEMICOLON+ERROR_PASSWORD
    })
