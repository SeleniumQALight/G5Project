...
public class RegistrationTestWithExcel extends BaseTest {
    ...
    loginPage
            .openLoginPage()
            .enterUserNameIntoIntoRegInput(userName)
            .enterEmailIntoRegInput(email)
            .enterPasswordIntoRegInput(password)
            .checkErrorsMessages(expectedErrors) //перевірка, що меседжів 3 і що в них текст конкретний
    ;
    }
}
