...
public class DataBaseTest {
    ...
    public void testDataFromDataBase() throws SQLException, ClassNotFoundException {
        List<Map<String, String>> dataFromSeleniumTable =
                mysqlDB.selectTableAsMap("select login, passWord from seleniumTable where login = 'G5_yefimchuk'");
        ...
        //      int rows = mysqlDB.changeTable("Insert Into seleniumTable VALUES(234, 'G5_yefimchuk', '123')");
        ...
        System.out.println(db_util.getPassForLogin("G5_yefimchuk"));
    }
