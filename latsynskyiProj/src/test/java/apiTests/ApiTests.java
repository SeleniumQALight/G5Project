    ...
    public void getAllPostsByUserPath(){
        Response actualeResponse =
                given()
                        ...
                        .log().all()
                        .extract().response();
    List<String> actualTitleList = actualeResponse.jsonPath().getList("title",String.class);
SoftAssertions softAssertions = new SoftAssertions();
...
List<Map> actualAutorList = actualeResponse.jsonPath().getList("author",Map.class);
